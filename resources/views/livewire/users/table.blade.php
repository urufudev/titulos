              ...
              <tr class="font-medium-2"> 
                ...
                <td class="text-bold-600 text-center">
                    <div class="btn-group" role="group" aria-label="Basic example">
                      @can('show', $user)    
                      <a href="{{route('users.show',$user->id)}}" class="btn btn-icon btn-info" data-toggle="tooltip" data-placement="top" data-original-title="Perfil">
                          <i class="bx bx-show"></i>
                        </a>
                       @endcan 
                      @can('update', $user)    
                      <a href="{{route('users.edit',$user->id)}}" class="btn btn-icon btn-success" data-toggle="tooltip" data-placement="top" data-original-title="Editar">
                      ...
                      <a style="cursor:pointer" data-target="#modal-delete-{{$user->id}}" data-toggle="modal" class="btn btn-icon btn-danger" data-placement="top" data-toggle="tooltip" title="Eliminar" >
                        ...
                        @elseif($user->status=='SUSPENDIDO')
                        <a style="cursor:pointer" data-target="#modal-delete-{{$user->id}}" data-toggle="modal" class="btn btn-icon btn-warning" data-placement="top" data-toggle="tooltip" title="Habilitar" >
