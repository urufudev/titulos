            ...
            <table class="table table-hover mb-1 ">
                <thead>
                    <tr class="font-medium-2" style="cursor:pointer">
                        <th wire:click.prevent="sortBy('students.id')" class="font-medium-1 text-center">
                            ID @include('partials._sort-icon',['field'=>'students.id'])
                        </th>
                        ...
                        <th wire:click.prevent="sortBy('institutes.name')" class="font-medium-1">

                            INSTITUTO @include('partials._sort-icon',['field'=>'institutes.name'])

                        </th>
                        <th {{-- wire:click.prevent="sortBy('carrers.name')" --}} class="font-medium-1 text-center">

                            CARRERA {{-- @include('partials._sort-icon',['field'=>'carrers.name']) --}}
                        </th>
