...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <!-- BEGIN: Body-->
  <body style="background-image: url({{asset('images/backgrounds/background.svg')}});" class="vertical-layout 1-column navbar-sticky {{$configData['bodyCustomClass']}} footer-static blank-page
