        ...
        <div class="sidebar">
            <div class="sidebar__top">
                ...
                <a class="sidebar__logo" href="index.html"><img class="sidebar__pic sidebar__pic_black"
                        src="{{ asset('frontend/img/logo.png') }}" alt="" /><img class="sidebar__pic sidebar__pic_white"
                        src="{{ asset('frontend/img/logo-white.png') }}" alt="" /></a><button
                    class="sidebar__burger"></button>
            </div>
            <div class="sidebar__wrapper">
                <div class="sidebar__inner">
                    <a class="sidebar__logo" href="index.html"><img class="sidebar__pic"
                            src="{{ asset('frontend/img/logo-sm.png') }}" alt="" /></a>
                                ...
                                <a class="sidebar__item" href="index.html">
                                    <div class="sidebar__icon">
                                        <svg class="icon icon-overview">
                                            <use xlink:href="{{ asset('frontend/img/sprite.svg#icon-overview') }}">
                                            </use>
                                        </svg>
                                    </div>
                                ...
                                <a class="sidebar__item" href="schedules.html">
                                    <div class="sidebar__icon">
                                        <svg class="icon icon-discovery">
                                            <use xlink:href="{{ asset('frontend/img/sprite.svg#icon-discovery') }}">
                                            </use>
                                        </svg>
                                    </div>
