...
<div class="modal fade text-left" id="modal-delete-{{$institute->id}}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button wire:click="destroy({{$institute}})"  class="btn btn-danger btn-svgs btn-svg-white">
